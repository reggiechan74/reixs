...
**Scope:** Shared field definitions used across multiple CRE roles — property identification, financial fundamentals, area measurement, party representation, lease classifications, temporal concepts, currency conventions, and document references.

**Relationship to REIXS:** This DDD provides canonical definitions for cross-cutting CRE concepts. Role-specific DDDs (lease abstraction, underwriting, asset management, appraisal) reference these shared definitions rather than redefining them, ensuring consistency across the REIXS ecosystem.

---

## Sections

The schema defines **8 sections** with **68 fields** total. All sections represent shared concepts used across multiple CRE roles and workflows.
